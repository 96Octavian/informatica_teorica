...
Date $f: A \to B$ e $g: B \to C$, $f$ _composto_ $g$ è la funzione $g \circ f: A \to C$ definita come $g\circ f (a) = g(f(a))$.  
...
\bot & \text{altrimenti} \\
\end{cases}$$
Scriviamo per abbreviare $B \cup \{\bot\} \to B_{\bot}$
